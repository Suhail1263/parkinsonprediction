...
import hashlib
import os.path #processing files from different places in the system
import random
import re
import sys
import tarfile
...
import numpy as np
from six.moves import urllib  #The six. moves module provides those modules under a common name for both Python2 and 3 
import tensorflow.compat.v1 as tf
#TensorFlow is an open source framework developed by 
#Google researchers to run machine learning, deep learning and other statistical 
...
def create_image_lists(image_dir, testing_percentage, validation_percentage):
  ...
  """
  if not gfile.Exists(image_dir): #os. path. exists() method in Python is used to check whether the specified path exists or not.
